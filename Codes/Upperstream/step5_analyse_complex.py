...
subprocess.call(f"{Path} --command=AnalyseComplex --pdb={pdb}_trimmed.pdb --analyseComplexChains=A,C", shell=True)
subprocess.call(f"{Path} --command=AnalyseComplex --pdb={pdb}_1_trimmed.pdb --analyseComplexChains=A,C", shell=True)
